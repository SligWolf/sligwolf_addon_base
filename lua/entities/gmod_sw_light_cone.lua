...
function ENT:RemoveProjectedTexture()
	if !CLIENT then return end
	if !IsValid(self.flashlighttex) then return end
...
function ENT:Initialize()	
	...
	if CLIENT then
		hook.Remove("RenderScene", "SW_CamInfo") 
		hook.Add("RenderScene", "SW_CamInfo", function(origin, angles, fov)
...
function ENT:Think()
	...
	if !IsValid(self.flashlighttex) and isON then
