...
function LIB.ToString(ent)
	...
	table.insert(output, entStr)

	if spawnname ~= "" then
		table.insert(output, string.format("[sn: %s]", spawnname))
	end

	if targetname ~= "" then
		table.insert(output, string.format("[tn: %s]", targetname))
	end

	if name ~= "" then
		table.insert(output, string.format("[n: %s]", name))
	end

	if addonname ~= "" then
		table.insert(output, string.format("[a: %s]", addonname))
	end
