...
function SLIGWOLF_ADDON:TimerUntil(identifier, delay, func, maxRepeats, maxTime)
	identifier = LIBTimer.GetAddonTimerName(self, identifier)
	if not identifier then
		return
	end
	...
	return LIBTimer.Until(identifier, delay, func, maxRepeats, maxTime)
end
...
function SLIGWOLF_ADDON:EntityTimerUntil(ent, identifier, delay, func, maxRepeats, maxTime)
	identifier = LIBTimer.GetEntityTimerName(ent, identifier)
	if not identifier then
		return
	end
	...
	return self:TimerUntil(identifier, delay, func, maxRepeats, maxTime)
end
